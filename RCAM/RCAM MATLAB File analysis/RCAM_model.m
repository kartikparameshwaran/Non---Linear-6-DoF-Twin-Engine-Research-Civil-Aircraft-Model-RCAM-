...
%%Commenting makes the RCAM Model not perform any kind of Control Limit
%%Saturation:
...
% Aerodynamic moment coefficients about aerodynamic centre in Fb:
CMac_b = eta + dCMdx*wbe_b + dCMdu*[u1;u2;u3];

% Dimensionalize aerodynamic moments about AC in Fb
